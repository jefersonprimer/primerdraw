...
export function PropertiesPanel({
  ...
  const first =
    selectedElements.length > 0
      ? selectedElements[0]
      : (DEFAULT_ELEMENT as WhiteboardElement);
  ...
  const Section = ({
    ...
    <div className={`mb-5 ${className}`}>
      <h4 className="text-[11px] font-bold text-gray-400 dark:text-neutral-500 uppercase tracking-widest mb-2.5">
        {title}
      </h4>
          ...
          <Section title="Stroke">
            <div className="flex items-center gap-1 w-full flex-wrap">
              {desktopStrokeColors.map((c) => (
                <button
                  key={c}
                  className={`w-7 h-7 rounded-lg border transition-all ${strokeForSwatch === c ? "ring-1 ring-blue-500 ring-offset-1 dark:ring-offset-[#1C1C1C] scale-110 shadow-sm" : "border-gray-100 dark:border-neutral-700 hover:border-gray-300 dark:hover:border-neutral-600"}`}
              ...
              <div className="w-full pt-2">
                <p className="text-[11px] font-semibold tracking-wide uppercase text-gray-400 dark:text-neutral-500 mb-2">
                  Shades
                </p>
                <div className="flex items-center gap-1">
                  {strokeShades.map((shade, index) => (
                    <button
                      key={`${shade}-${index}`}
                      className={`w-7 h-7 rounded-lg border transition-all ${strokeForSwatch === shade ? "ring-1 ring-blue-500 ring-offset-1 dark:ring-offset-[#1C1C1C] scale-110 shadow-sm" : "border-gray-100 dark:border-neutral-700 hover:border-gray-300 dark:hover:border-neutral-600"}`}
            ...
            <div className="flex items-center gap-1 w-full flex-wrap">
              {desktopBackgroundColors.map((c, i) => {
                ...
                return (
                  <button
                    key={c + i}
                    className={`w-7 h-7 rounded-lg border flex items-center justify-center transition-all ${first.fill === c ? "ring-1 ring-blue-500 ring-offset-1 dark:ring-offset-[#1C1C1C] scale-110 shadow-sm" : "border-gray-100 dark:border-neutral-700 hover:border-gray-300 dark:hover:border-neutral-600"}`}
                    style={
              ...
              <div className="w-full pt-2">
                ...
                <div className="flex items-center gap-1.5">
                  {backgroundShades.map((shade, index) => (
                    <button
                      key={`${shade}-${index}`}
                      className={`w-7 h-7 rounded-lg border transition-all ${first.fill === shade ? "ring-2 ring-blue-500 ring-offset-2 dark:ring-offset-[#1C1C1C] scale-110 shadow-sm" : "border-gray-100 dark:border-neutral-700 hover:border-gray-300 dark:hover:border-neutral-600"}`}
                      style={{ backgroundColor: shade }}
          ...
          <>
            ...
            <Section title="Arrowheads">
              <div className="flex flex-wrap items-center gap-2 w-full">
                <span className="text-[11px] text-gray-500 dark:text-neutral-400 w-full">
                  Ponta no fim
                </span>
                {[true, false].map((ah) => (
                  <button
                ...
                <span className="text-[11px] text-gray-500 dark:text-neutral-400 w-full mt-1">
                ...
                <div className="w-full mt-1 relative">
                  <span className="text-[11px] text-gray-500 dark:text-neutral-400 block mb-1">
                    Estilo da ponta
                  </span>
        ...
        <Section title="Layers" className="mb-0">
          <div className="flex items-center gap-2">
            <button
              ...
              title="To Front"
              className="w-8 h-8 p-1 bg-gray-50/30 dark:bg-neutral-800/50 hover:bg-gray-100 dark:hover:bg-neutral-700 hover:border-gray-200 dark:hover:border-neutral-600 flex items-center justify-center text-black dark:text-white transition-all rounded-md"
            >
            ...
            <button
              ...
              title="Forward"
              className="w-8 h-8 p-1 bg-gray-50/30 dark:bg-neutral-800/50 hover:bg-gray-100 dark:hover:bg-neutral-700 hover:border-gray-200 dark:hover:border-neutral-600 rounded-md flex items-center justify-center text-black dark:text-white transition-all"
            >
              <MoveDown size={20} />
            </button>
            <button
        ...
        mobileModal(
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => onLayerChange("front")}
              title="To Front"
              className="w-7 h-7 rounded-md bg-gray-50/30 dark:bg-neutral-800/50 hover:bg-gray-100 dark:hover:bg-neutral-700 flex items-center justify-center text-black dark:text-white transition-all"
            >
