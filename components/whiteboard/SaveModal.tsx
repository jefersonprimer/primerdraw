  ...
  return (
    <>
      <div className="fixed inset-0 z-[200] flex items-center justify-center">
        ...
        {/* Modal */}
        <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 border border-neutral-200 max-h-[90vh] overflow-y-auto">
          <div className="flex items-center justify-between p-4 border-b border-neutral-200">
            <h2 className="text-lg font-semibold text-[#1b1b1f]">Save to</h2>
            <button
              onClick={onClose}
          ...
          <div className="p-6 space-y-8">
            ...
            <section className="space-y-4">
              <h3 className="text-sm font-semibold text-[#1b1b1f]">Save to disk</h3>
            ...
            <section className="space-y-3 pt-4 border-t border-neutral-200">
              <h3 className="text-sm font-semibold text-[#1b1b1f]">Shareable link</h3>
              <p className="text-sm text-neutral-600">
